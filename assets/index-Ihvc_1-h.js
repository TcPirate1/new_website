...
cls           Clear screen
`),t.style.textAlign=`center`;break;case`rss`:a(),t.textContent=`This does nothing at the moment.`,t.style.textAlign=`center`;break;case`ip`:a(),i(n).then(e=>{t.textContent=e}),t.style.textAlign=`center`;break;case`ua`:a(),i(n).then(e=>{t.textContent=e}),t.style.textAlign=`center`;break;case`cd`:a(),u();break;case`ex`:a(),l(),t.style.textAlign=`center`;break;case`about`:a(),s(),t.style.textAlign=`center`;break;case`ls`:a(),c(),t.style.textAlign=`center`;break;case`cls`:a(),t?.replaceChildren(),t.style.textAlign=`center`;break;default:a(),d(`Command not found: ${n}`),t.style.textAlign=`center`}}function s(){t.textContent=`
